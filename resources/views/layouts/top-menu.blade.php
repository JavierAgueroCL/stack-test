<div class="m-stack__item m-stack__item--fluid m-header-menu-wrapper">
  ...
  <div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-dark m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light "  >
    <ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
      <li class="m-menu__item {{ Request::is( '/') ? 'm-menu__item--active m-menu__item--active-tab' : '' }}  m-menu__item--submenu m-menu__item--tabs"  data-menu-submenu-toggle="tab" aria-haspopup="true">
        ...
        <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs">
          ...
          <ul class="m-menu__subnav">
            <li class="m-menu__item {{ Request::is( '/') ? 'm-menu__item--active' : '' }}"  data-redirect="true" aria-haspopup="true">
            ...
            <li class="m-menu__item menu-disabled"  aria-haspopup="true">
              <a  href="#" class="m-menu__link">
            ...
            <li class="m-menu__item  menu-disabled"  data-redirect="true" aria-haspopup="true">
              <a  href="#" class="m-menu__link ">
            ...
            <li class="m-menu__item  menu-disabled  m-menu__item--submenu m-menu__item--rel m-menu__item--submenu-tabs"  data-menu-submenu-toggle="click" data-redirect="true" aria-haspopup="true">
      ...
      <li class="m-menu__item {{ MenuHelper::prefix('maestros') }}  m-menu__item--submenu m-menu__item--tabs"  data-menu-submenu-toggle="tab" aria-haspopup="true">
        <a  href="#" class="m-menu__link m-menu__toggle">
          <span class="m-menu__link-text">
            Maestros
          </span>
        ...
        <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left m-menu__submenu--tabs">
          ...
          <ul class="m-menu__subnav">
            <li class="m-menu__item {{ MenuHelper::submenu('clientes') }}"  data-redirect="true" aria-haspopup="true">
              <a  href="{{ route('maestros.clientes') }}" class="m-menu__link ">
                <i class="m-menu__link-icon flaticon-graphic-2"></i>
                <span class="m-menu__link-text">
